...
const dashboardShelfVariants = cva("", {
  variants: {
    desktopBehavior: {
      shelf:
        "md:inline-flex md:max-w-fit md:flex-row md:gap-8 md:overflow-x-auto md:pb-8",
      grid: "md:grid md:w-full md:grid-cols-dashboard-shelf md:gap-12",
    },
    mobileBehavior: {
      default:
        "inline-flex w-full flex-row gap-8 overflow-x-auto pb-8 md:gap-12",
